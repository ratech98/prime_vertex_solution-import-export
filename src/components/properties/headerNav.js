...
const HeaderNav = () => {
    ...
    return(
        <>
            <div>
                <div className="bg-transparent backdrop-blur-md w-full fixed flex justify-between h-16 px-5 py-2">
                        ...
                        <div className="">
                            <div className={`absolute top-16 -left-full top-0 flex flex-col justify-between pb-20 md:hidden z-50 text-black h-screen pt-10 transition-transform backdrop-blur-md bg-black text-white translate-x-full w-full ${showMenu === true ? null : 'hidden'}`}>
                                <ul className="*:bg-red-20 *:my-2 font-bold text-xl *:p-2 *:text-center *:flex *:items-center *:justify-center ">
                                    <a onClick={()=>setShowMenu(!showMenu)} href="#Home" className=" text-[#F7722D] group hover:font-semibold *:mx-2" style={{fontWeight : Router.pathname === '/' ? 'bold': null,background:Router.pathname==='/'?'#f3f4f6':null,}}>
                                    ...
                                    <a  onClick={()=>setShowMenu(!showMenu)} href='#aboutUs' className="text-[#F7722D] group hover:font-semibold *:mx-2" style={{fontWeight : Router.pathname === '/about' ? 'bold': null,background:Router.pathname==='/about'?'#f3f4f6':null,}}>
