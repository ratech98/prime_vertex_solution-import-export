                ...
                <div className="">
                    ...
                    <div className="flex hidden xl:block flex-col items-center justify-center gap-8 px-8 py-16">
                        <div className="flex gap-2">
                            <div data-aos="flip-left" data-aos-duration="1000" data-aos-delay="50" className="w-10/12 p-5">
                        ...
                        <div className="flex">
                            ...
                            <div data-aos="flip-left" data-aos-duration="1000" data-aos-delay="50" className="w-10/12 p-5 flex items-center justify-center">
                                ...
                                className="animated-card flex border-2 cursor-pointer rounded-2xl w-3/4 h-full items-center justify-center hover:scale-75 hover:ease-in duration-700">
                    ...
                    <div className="flex hidden md:block xl:hidden flex-col items-center justify-center gap-8 px-8 py-16">
                        ...
                        <div className="flex">
                            ...
                            <div data-aos="flip-left" data-aos-duration="1000" data-aos-delay="50" className="w-10/12 p-5 flex items-center justify-center">
                                <div className="flex border-2 cursor-pointer rounded-2xl w-3/4 h-full items-center justify-center">
                                    <button className="flex items-center justify-center rounded-full">
                                        <div>
                                            <p className="font-bold text-lg">For more details</p>
                                            <p>Click here</p>
