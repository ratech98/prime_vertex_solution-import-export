                    ...
                    <div>
                        <div>
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <button type="submit" className="bg-[#F7722D] rounded-full w-full text-white p-2 self-center">
                                    Submit
                                </button>
                            </div>
                        </div>
            ...
            <div className="bg-white flex flex-col items-center justify-center ">
                <div className="w-11/12 ">
                    ...
                    <div className="flex flex-col lg:flex-row flex-col-reverse">
                        ...
                        <div className="w-full mx-auto max-w-screen-xl p-4 flex flex-co gap-5">
                            <span className="text-sm text-gray-500 "><a href="https://flowbite.com/" className="hover:underline">Terms Of Service</a></span>
                            <span className="text-sm text-gray-500 "><a href="https://flowbite.com/" className="hover:underline">Privacy Policy</a></span>
                        </div>
